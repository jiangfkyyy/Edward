...
<script type="text/javascript"> 
  ...
  var riqi1=Math.ceil(t1/(1000*60*60*24));
     ...
     document.write('还有 <span style="color:#ff4300;">'+riqi1+'</span> 天 ');   
                ...
                <li>
                        <a><img src="https://www.xujianhua.com/yes.png">                   
                        <h4>XX节2</h4><p><script type="text/javascript"> 
  //获取当前系统时间
  var now=new Date();
  //获取节日时间
  ...
  var riqi2=Math.ceil(t2/(1000*60*60*24));
     ...
     document.write('还有 <span style="color:#ff4300;">'+riqi2+'</span> 天');
                ...
                <li>
                        <a><img src="https://www.xujianhua.com/yes.png">                   
                        <h4>XX节3</h4><p><script type="text/javascript"> 
  //获取当前系统时间
  var now=new Date();
  //获取节日时间
  ...
  var riqi3=Math.ceil(t3/(1000*60*60*24));
     ...
     document.write('还有 <span style="color:#ff4300;">'+riqi3+'</span> 天');
                ...
                <li>
                        <a><img src="https://www.xujianhua.com/yes.png">                   
                        <h4>XX节4</h4><p><script type="text/javascript"> 
  //获取当前系统时间
  var now=new Date();
  //获取节日时间
  ...
  var riqi4=Math.ceil(t4/(1000*60*60*24));
     ...
     document.write('还有 <span style="color:#ff4300;">'+riqi4+'</span> 天');
                ...
                <li>
                    <a><img src="https://www.xujianhua.com/yes.png">
                        <h4>XX在一起1</h4><p>距离现在一起度过了<?php echo floor((time()-strtotime('2018-05-20'))/86400);?>天</p>
                    </a>
                </li>
                <li>
                    <a><img src="https://www.xujianhua.com/yes.png">
                        <h4>XX在一起2</h4><p>距离现在一起度过了<?php echo floor((time()-strtotime('2018-05-20'))/86400);?>天</p>
                    </a>
                </li>
                <li>
                    <a><img src="https://www.xujianhua.com/yes.png">
                        <h4>XX在一起3</h4><p>距离现在一起度过了<?php echo floor((time()-strtotime('2018-05-20'))/86400);?>天</p>
                    </a>
                </li>
                <li>
                    <a><img src="https://www.xujianhua.com/yes.png">
                        <h4>XX在一起4</h4><p>距离现在一起度过了<?php echo floor((time()-strtotime('2018-05-20'))/86400);?>天</p>
                    </a>
                </li>
            </ul>
            <?php $this->content(); ?>
